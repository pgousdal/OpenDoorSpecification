...
class M61CrosswalkCoverageTests(unittest.TestCase):
    def test_summary_totals(self):
        ...
        self.assertEqual(summary["reviewed"], 42)
        self.assertEqual(summary["verified"] + summary["partial"], 42)
        self.assertEqual(summary["unassessed"], 48)
    ...
    def test_cli_coverage(self):
        ...
        self.assertIn("42/90", result.stdout)
